...
def test_execute_job():
    jobs = DataGenerator.generate_jobs(number_of_atoms=4, number_of_jobs=1, method = "fci")
...
def test_spa_pipeline(square_coordinates):
    ...
    result = DataGenerator.run_spa_optimization(molecule = mol, coordinates = square_coordinates)
